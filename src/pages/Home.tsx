...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center max-sm:px-0 xl:px-0 bg-gradient-to-t from-[#121212] to-[#424242]">
      ...
      <div
        id="home"
        className="flex-grow w-full min-h-screen bg-gradient-to-t from-[#121212] to-[#424242]"
      >
        <Navbar onLoginClick={openRolePopup} />
        <div className="w-full max-w-3xl mx-auto p-2 mt-24">
          <div className="text-center mt-24">
            <h1 className="text-6xl font-bold text-[#FFFFFF] mb-5">Digital</h1>
            <h1 className="text-6xl font-bold text-[#FFFFFF] mb-5">
              Platform For
            </h1>
            <h2 className="text-6xl font-bold text-[#1E88E5]">All Employee</h2>
            <p className="text-lg mt-6 text-white px-1 space-y-64 drop-shadow-2xl font-sans">
      ...
      <div
        id="about"
        className="py-16 w-full min-h-screen flex flex-col items-center bg-gradient-to-t from-[#2E2D42] to-[#121212]"
      >
      ...
      <div
        id="features"
        className="py-16 w-full min-h-screen flex bg-gradient-to-t from-[#424242] to-[#2E2D42]"
      >
        <div className="flex flex-wrap lg:flex-row items-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 lg:space-y-0 lg:space-x-12">
          <div className="flex flex-col px-0 space-y-14 text-center lg:text-left text-white">
            ...
            <div className="space-y-4">
              <div className="flex items-start justify-center lg:justify-between">
                ...
                />
                <div>
                  <h3 className="font-bold text-2xl drop-shadow-2xl justify-center items-center text-white mb-5">
                    Check In
                  </h3>
                  <p className="text-sm lg:text-base text-white px-1 space-y-64 drop-shadow-2xl font-sans">
