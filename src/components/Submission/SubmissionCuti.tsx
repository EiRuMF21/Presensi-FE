...
const SubmissionCuti: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-gray-200 items-center justify-center">
      <div className="bg-white rounded-md shadow-lg w-full max-w-5xl h-full">
        {/* Header */}
        <div className="bg-gray-200 p-4 rounded-t-md flex items-center space-x-2">
          ...
          <h1 className="text-xl text-gray-800">LEAVE REQUEST</h1>
        </div>
                ...
                >
                  ...
                  <td className="py-3 px-6 text-left">
                    <div className="flex">
                      ...
                      <button className="ml-2 px-4 py-1 bg-red-500 text-white rounded-full">
                        Decline
                      </button>
                    </div>
                  </td>
                  <td className="py-3 px-6 text-left">information...</td>
                </tr>
              ))}
            </tbody>
          </table>
